...
public class TextureViewDescriptor : NewNewChainedStruct<Silk.NET.WebGPU.TextureViewDescriptor>
{
    ...
    internal override TextureViewDescriptor Clone()
    {
        var clone = new TextureViewDescriptor();
        clone.Native = Native;
        clone.Next = Next;
        return clone;
    }
