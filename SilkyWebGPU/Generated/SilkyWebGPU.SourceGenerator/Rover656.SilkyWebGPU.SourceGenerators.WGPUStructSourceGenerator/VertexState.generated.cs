...
public class VertexState : NewNewChainedStruct<Silk.NET.WebGPU.VertexState>
{
    ...
    /// Summary: Will update if you modify the existing pointer, but if you replace it, it won't.
    /// </remarks>
    public unsafe NativeArray<Silk.NET.WebGPU.VertexBufferLayout> Buffers
    {
        // Return a readonly weak copy.
        get => new NativeArray<Silk.NET.WebGPU.VertexBufferLayout>((uint) Native.BufferCount, Native.Buffers);
        ...
        set
        {
            ...
            if (value != null)
            {
                ...
                Native.BufferCount = value.Count;
            }
            else
            {
                Native.Buffers = null;
