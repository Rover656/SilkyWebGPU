...
public class SupportedLimitsExtras : NewNewChainedStruct<Silk.NET.WebGPU.Extensions.WGPU.SupportedLimitsExtras>
{
    ...
    internal override SupportedLimitsExtras Clone()
    {
        var clone = new SupportedLimitsExtras();
        clone.Native = Native;
        clone.Next = Next;
        return clone;
    }
