...
public sealed unsafe class PrimitiveState : ChainedStruct<Silk.NET.WebGPU.PrimitiveState>
{
    public static implicit operator Silk.NET.WebGPU.PrimitiveState(PrimitiveState managed)
        => managed != null ? managed.Get() : default;

    public static implicit operator Span<Silk.NET.WebGPU.PrimitiveState>(PrimitiveState managed)
