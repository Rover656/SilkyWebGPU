...
public sealed unsafe class BindGroupEntry : ChainedStruct<Silk.NET.WebGPU.BindGroupEntry>
{
    public static implicit operator Silk.NET.WebGPU.BindGroupEntry(BindGroupEntry managed)
        => managed != null ? managed.Get() : default;

    public static implicit operator Span<Silk.NET.WebGPU.BindGroupEntry>(BindGroupEntry managed)
    ...
    public WebGPUPtr<Silk.NET.WebGPU.Sampler> Sampler
    {
    ...
    public WebGPUPtr<Silk.NET.WebGPU.TextureView> TextureView
    {
