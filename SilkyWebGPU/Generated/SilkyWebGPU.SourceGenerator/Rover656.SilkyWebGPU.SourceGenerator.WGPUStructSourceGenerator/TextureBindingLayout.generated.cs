...
public sealed unsafe class TextureBindingLayout : ChainedStruct<Silk.NET.WebGPU.TextureBindingLayout>
{
    public static implicit operator Silk.NET.WebGPU.TextureBindingLayout(TextureBindingLayout managed)
        => managed != null ? managed.Get() : default;

    public static implicit operator Span<Silk.NET.WebGPU.TextureBindingLayout>(TextureBindingLayout managed)
