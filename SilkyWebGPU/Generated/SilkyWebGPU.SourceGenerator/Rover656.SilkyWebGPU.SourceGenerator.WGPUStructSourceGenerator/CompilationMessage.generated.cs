...
public sealed unsafe class CompilationMessage : ChainedStruct<Silk.NET.WebGPU.CompilationMessage>
{
    public static implicit operator Silk.NET.WebGPU.CompilationMessage(CompilationMessage managed)
        => managed != null ? managed.Get() : default;

    public static implicit operator Span<Silk.NET.WebGPU.CompilationMessage>(CompilationMessage managed)
