...
public sealed unsafe class RenderPassDepthStencilAttachment : WrappedStruct<Silk.NET.WebGPU.RenderPassDepthStencilAttachment>
{
    public RenderPassDepthStencilAttachment() : base() { }
    public RenderPassDepthStencilAttachment(Silk.NET.WebGPU.RenderPassDepthStencilAttachment native) : base(native) { }

    public static implicit operator RenderPassDepthStencilAttachment(Silk.NET.WebGPU.RenderPassDepthStencilAttachment native)
        => new RenderPassDepthStencilAttachment(native);
