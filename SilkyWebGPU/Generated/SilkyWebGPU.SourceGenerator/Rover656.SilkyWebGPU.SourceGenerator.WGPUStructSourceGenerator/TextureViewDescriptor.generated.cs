...
public sealed unsafe class TextureViewDescriptor : ChainedStruct<Silk.NET.WebGPU.TextureViewDescriptor>
{
    public static implicit operator Silk.NET.WebGPU.TextureViewDescriptor(TextureViewDescriptor managed)
        => managed != null ? managed.Get() : default;

    public static implicit operator Span<Silk.NET.WebGPU.TextureViewDescriptor>(TextureViewDescriptor managed)
