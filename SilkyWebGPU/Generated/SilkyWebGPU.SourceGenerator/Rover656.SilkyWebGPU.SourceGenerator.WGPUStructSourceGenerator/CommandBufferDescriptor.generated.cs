...
public sealed unsafe class CommandBufferDescriptor : ChainedStruct<Silk.NET.WebGPU.CommandBufferDescriptor>
{
    public static implicit operator Silk.NET.WebGPU.CommandBufferDescriptor(CommandBufferDescriptor managed)
        => managed != null ? managed.Get() : default;

    public static implicit operator Span<Silk.NET.WebGPU.CommandBufferDescriptor>(CommandBufferDescriptor managed)
