...
{
    [Generator]
    public class WGPUSourceGenerator : ISourceGenerator
    {
        /// <summary>
        /// The namespace of the generated class
        /// </summary>
        private const string ExtensionNS = "Rover656.SilkyWebGPU";

        /// <summary>
        /// The name of the generated class
        /// </summary>
        private const string ClassName = "Extensions";

        /// <summary>
        /// The WebGPU binding namespace.
        /// </summary>
        private const string WebGpuNS = "Silk.NET.WebGPU";

        /// <summary>
        /// The native pointer type used for wrapping Web GPU native objects.
        /// </summary>
        private const string NativePtrType = "WebGPUPtr";
        ...
        {
            var webGpu = context.Compilation.GetTypeByMetadataName($"{WebGpuNS}.WebGPU");

            var outputWriter = new StringBuilder($@"// <auto-generated/>
// Temporary while in development
using {ExtensionNS};
using {ExtensionNS}.Chain;
...
");
    ...
    /// <summary>
    /// {method.Name}
    /// Generated from <see cref=""{WebGpuNS}.WebGPU""/>.
    /// </summary>
    public static unsafe {NativePtrType}<{returnType}> {methodName}{typeParameterList}(this {NativePtrType}<{objectType}> {method.Parameters[0].Name}{parameterList}) {typeParameterConstraints}
    {{{chainableHeader}
        return new {NativePtrType}<{returnType}>(WGPU.API.{method.Name}({method.Parameters[0].Name}{argumentList}));
    }}
");
        }
    ...
    /// Generated from <see cref=""{WebGpuNS}.WebGPU""/>
    /// </summary>
    public static unsafe {method.ReturnType} {methodName}{typeParameterList}(this {NativePtrType}<{objectType}> {method.Parameters[0].Name}{parameterList}) {typeParameterConstraints}
    {{{chainableHeader}
...
");
    ...
    /// Generated from <see cref=""{WebGpuNS}.WebGPU""/>
    /// </summary>
    public static unsafe void {methodName}{typeParameterList}(this {NativePtrType}<{objectType}> {method.Parameters[0].Name}{parameterList}) {typeParameterConstraints}
    {{{chainableHeader}
...
");
        ...
        private string GetParameterType(IParameterSymbol parameter, bool resolveChainable = false)
        {
            if (parameter.Type is IPointerTypeSymbol pointerType)
            {
                ...
                {
                    return $"{NativePtrType}<{pointerType.PointedAtType}>";
                }
